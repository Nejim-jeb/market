...
class MenuListWebWidget extends StatelessWidget {
  ...
  const MenuListWebWidget({Key? key, required this.isLoggedIn})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final List<MenuModel> menuList = [
      MenuModel(
          ...
          route: RouteHelper.orderListScreen),
      MenuModel(
          icon: Images.trackOrder,
          title: getTranslated('track_order', context),
          route: RouteHelper.orderSearchScreen),
      MenuModel(
                    ...
                    child: Container(
                      ...
                      child: ClipOval(
                        child: isLoggedIn
                            ...
                            : const CustomAssetImageWidget(Images.placeHolder,
