                                                        ...
                                                        Text(
                                                          couponProvider
                                                              ...
                                                              ? getTranslated(
                                                                  'free_delivery',
                                                                  context)
                                                              : '${couponProvider.couponList![index].discount}${couponProvider.couponList![index].discountType == 'percent' ? '%' : Provider.of<SplashProvider>(context, listen: false).configModel!.currencySymbol} off',
                                                          style: poppinsMedium
                                                              .copyWith(
                                                                  color: Colors
                                                                      .white,
